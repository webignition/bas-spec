...
project = u'Basil Language'
copyright = u'2019, Jon Cram'
author = u'Jon Cram'
...
exclude_patterns = [u'_build', 'Thumbs.db', '.DS_Store', 'includes/*.rst']
...
latex_documents = [
    (master_doc, 'ProjectName.tex', u'Project Name Documentation',
     u'Jon Cram', 'manual'),
]
...
man_pages = [
    (master_doc, 'projectname', u'Project Name Documentation',
     [author], 1)
]
